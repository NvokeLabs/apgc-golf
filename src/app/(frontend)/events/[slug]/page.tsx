...
export default async function EventPage({ params }: Args) {
  ...
  const isDisabled = event.status === 'sold-out' || event.status === 'closed' || event.status === 'completed'
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <GlassCard className="p-8 sticky top-32">
              ...
              {event.price && (
                <div className="mb-6">
                  <p className="text-[#636364] text-xs uppercase tracking-wider mb-1">Entry Fee</p>
