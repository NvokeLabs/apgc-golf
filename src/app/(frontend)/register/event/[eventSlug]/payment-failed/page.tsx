    ...
    <div className="container flex min-h-[60vh] items-center justify-center pt-24 pb-16">
      <GlassCard className="max-w-lg p-8 text-center">
        ...
        <p className="mb-6 text-gray-600">
          Unfortunately, your payment could not be processed. This may be due to insufficient
          funds, an expired card, or a temporary issue with the payment provider.
        </p>

        <div className="mb-8 rounded-lg bg-amber-50 p-4">
          <p className="text-sm text-amber-700">
            Your registration has been saved. You can try again with a different payment method or
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-gray-500">
            Need help?{' '}
            <a href="mailto:info@apgc-golf.com" className="text-emerald-600 hover:underline">
              Contact us
            </a>
          </p>
        </div>
